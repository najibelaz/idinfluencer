		...
		monthly: function (customOptions) {
			...
			function setMonthly(month, year) {
				...
				for (var dayNumber = 1; dayNumber <= dayQty; dayNumber++) {
					...
					var isInPast = options.stylePast && (
						...
						innerMarkup = '<div class="schedule-old" data-day="' + year + "/" + month + "/" + dayNumber + '"><div class="schedule-old-list schedule-old-scrollbar scrollbar-dynamic"></div></div>';
			...
			function addEvent(event, setMonth, setYear) {
				...
				var startTime = _getEventDetail(event, "starttime"),
					...
					evenContent = _getEventDetail(event, "content"),
			...
			$(document.body).on("click", parent + " .monthly-next", function (event) {
				...
				if ($(".schedule-old-scrollbar").length > 0) {
					$('.schedule-old-scrollbar').niceScroll({
						cursorcolor: "#ddd"
					});
				}
				return false;

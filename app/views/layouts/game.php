...
<head>
    ...
    <?php
        if(!empty($game->img)){
            ...
            $imgOG = cn("themes/aruba/assets/img/bg-login-id.jpg");
        }
    ?>
    <meta property="og:url"                content="<?= current_url(); ?>" />
    <meta property="og:type"               content="article" />
    <meta property="og:title"              content="<?= nl2br($game->name) ?>" />
    <meta property="og:description"        content="<?= nl2br($game->description) ?>" />
    <meta property="og:image"              content="<?= $imgOG ?>" />
    <meta property="og:image:secure_url"   content="<?= $imgOG ?>" />
    <meta property="fb:app_id"             content="<?=get_option("facebook_app_id", '508937386543575') ?>" />

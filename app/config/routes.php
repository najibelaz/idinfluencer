...
$route['game/(:any)'] = 'auth/participer_front/$1';
$route['add_participant'] = 'auth/add_participant';
$route['send_parrain'] = 'auth/send_parrain';
$route['game_success/(:any)/(:any)'] = 'auth/success/$1/$2';
$route['game_success_2/(:any)'] = 'auth/success_2/$1';
$route["users_add_user_cron"] = "users/add_user_cron";
$route["reconduction_user"] = "users/reconductionUser";
$route["listPostFBCrone"] = "schedules/listPostFBCrone"; 
...
if (!function_exists('get_path_upload')) {
	function get_path_upload($file_name = ""){
		$userid = user_or_cm();
		return APPPATH."../assets/uploads/user".$userid."/".$file_name;
	};
}
...
if (!function_exists('get_link_file')) {
	function get_link_file($file_name){
		$userid = user_or_cm();
		return BASE."assets/uploads/user".$userid."/".$file_name;
	};
}
...
if (!function_exists('get_file_via_curl')){
	function get_file_via_curl($url, $file_name){
		$ch = curl_init($url);
		$userid = user_or_cm();
		$fp = fopen(APPPATH.'../assets/uploads/user'.$userid.'/'.$file_name, 'wb');

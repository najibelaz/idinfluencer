<div class="row top-title">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <h4> <i class="material-icons">people</i> <?=lang('users')?></h4>
    </div>
</div>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="item item-2 border <?=segment(3)==""?"active":""?>">
                        <a href="<?=cn("users")?>" data-content="pn-ajax-content" data-result="html" class="actionItem"
                            onclick="history.pushState(null, '', '<?=cn("users")?>');">
                    ...
                    <div class="item item-2 border <?=segment(3)=="social"?"active":""?>">
                        <a href="<?=cn("users/index/statistics")?>" data-content="pn-ajax-content" data-result="html"
                            class="actionItem"
                            onclick="history.pushState(null, '', '<?=cn("users/index/statistics")?>');">

...
<form action="<?=cn('payment/stripe/process')?>" method="post" id="payment-form">
	<div class="text-center">
		<?php if(get_option('stripe_type', 0) == 0){?>
		<div class="pure-checkbox grey mr15 mb15">
	        <input type="radio" id="md_checkbox_payment_method enable" name="payment_method" class="filled-in chk-col-red payment_method" checked="" value="1">
	        <label class="p0 m0" for="md_checkbox_payment_method enable">&nbsp;</label>
	        <span class="checkbox-text-right"> <?=lang('Recurring Payment')?></span>
	    </div>

	    <div class="pure-checkbox grey mr15 mb15">
	        <input type="radio" id="md_checkbox_payment_method disable" name="payment_method" class="filled-in chk-col-red payment_method" value="0">
	        <label class="p0 m0" for="md_checkbox_payment_method disable">&nbsp;</label>
	        <span class="checkbox-text-right"> <?=lang('One-Time Payment')?></span>
	    </div>
		<?php }elseif( get_option('stripe_type', 0) == 1 ){?>
		<input type="radio" id="md_checkbox_payment_method enable" name="payment_method" class="filled-in chk-col-red payment_method hide" checked="" value="1">
		<?php }else{?>
		<input type="radio" id="md_checkbox_payment_method disable" name="payment_method" class="filled-in chk-col-red payment_method hide" checked="" value="0">
		<?php }?>
	</div>

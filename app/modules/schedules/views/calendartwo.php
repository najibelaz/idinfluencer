                        ...
                        ?>
                            <li class="list-grps">
                                ...
                                <ul class="list-slide pl-3"
                                    ...
                                    <?php
                                        if (!empty($account_info)) { 
                                            foreach ($account_info as $key => $row1) {
                                                $account_name = ""; 
                                                if (isset($row1->fullname)) {
                                                    $account_name = $row1->fullname; 
                                                }else{
                                                    $account_name = $row1->username; 
                                                }
                                    ...
                                    <li>
                                        <div class="checkbox">
                                            <input type="checkbox" name="account_filter[]"
                                                id="md_checkbox_<?=$row->ids.'_'.$row1->ids?>"
                                                <?php if(in_array($row->ids.'_'.$row1->ids, $account_filter) || empty($sc_type)) {?>
                                                checked="" <?php } ?> value="<?= $row->ids.'_'.str_replace(" ", "_", $row1->ids)?>">
                                            <label class="" for="md_checkbox_<?=$row->ids.'_'.$row1->ids?>">
                                                <span class="name" style="color: <?=$row1->color?>"><i
                                                        class="fa fa-<?=$row1->social_label?>"></i>
                                                    <?=$account_name?></span>
                                            </label>
                        ...
                        <ul class="days days-contents">
                            ...
                            <?php } ?> -->
                                <div class="d-info">
                                    ...
                                    <span class="date">
                                        <?php
                                        if($num_mois == date("n") && $tab_cal[$i][$j] == date("d")){

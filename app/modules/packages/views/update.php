			...
			<div class="users">
			  	<div class="card">
			  			...
			  			<div class="row">
			  				<div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="price_monthly_ht">  <?=lang('price_monthly_ht')?></label>
                                            <input type="text" class="form-control" name="price_monthly" id="price_monthly_ht" value="<?=!empty($result)?(float)$result->price_monthly_ht:"0"?>">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label for="price_monthly_ttc">  <?=lang('price_monthly_ttc')?></label>
                                            <input type="text" class="form-control" name="price_monthly_ttc" id="price_monthly_ttc" value="<?=!empty($result)?(float)$result->price_monthly_ttc:"0"?>">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="p0 m0" for="is_monthly">&nbsp;</label>
                                            <span class="checkbox-text-right">  <?=lang('is_monthly')?></span>
                                        </div>
                                    </div>
			  		...
			  		<div class="card-footer">
                        ...
                        <?php if(!empty($result)){?>
	                    <a href="<?=cn($module."/ajax_update")?>" class="btn btn-secondary pull-right mr15 actionMultiItem" data-params="subscribers=1" > <?=lang('save_and_update_subscribers')?></a>
                        <?php }?>
	                    <div class="clearfix"></div>
			  		</div>
			  	</div>

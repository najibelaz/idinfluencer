<!-- <div class="row top-title">
    <div class="col-lg-6 col-md-6 col-sm-12">
        <h4><i class="material-icons">games</i> jeu 1</h4>
    </div>
</div> -->
                    ...
                    <div class="single_post">
                        ...
                        <div class="body">
                            <div class="img-post m-b-15">
                                <img src="https://via.placeholder.com/1428x600" alt="Awesome Image">
                        ...
                        <div class="body">
                            <div class="card-imgdisc">
                                ...
                                <div class="card-content">
                                    ...
                                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eaque odit a doloribus

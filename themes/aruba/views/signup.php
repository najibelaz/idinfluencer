<?=Modules::run(get_theme()."/header", false)?>
	...
	<section class="login-page">
		<div class="login-form">
			<div class="logo">
				<a href="<?=cn()?>"><img class="logo-black" src="<?=get_option("website_logo_black", BASE.'assets/img/logo-black.png.png')?>"></a>
			</div>
			...
			<div class="login-box mb-3">
				...
				<div class="mb-3">
					...
					<label class="cbx" for="cbx"><span>
					    ...
					    </svg></span><span><?=lang("i have read and accept the")?> <a href="<?=cn("p/terms_and_policies")?>"><?=lang("Terms of Services")?></a></span>
					</label>
            	</div>

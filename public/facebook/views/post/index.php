...
<form class="actionForm" action="<?=cn($module_name."/post/ajax_post")?>">
    <div class="wrap-content row all-post">
                ...
                <div class="box-search ">
                    <div class="input-group">
                        ...
                        <div class="input-group-btn">
                            <button type="button" class="btn btn-primary btn-icon  btn-icon-mini btn-round ap-select-all"
                                title="<?=lang("select_all")?>"><i class="ft-check"></i></button>
                            <button type="button" class="btn btn-primary btn-icon  btn-icon-mini btn-round dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false" title="<?=lang("Groups")?>"><i
                                    class="ft-target"></i></button>
        ...
        <div class="am-wrapper col-md-12 col-lg-9">
            <div class="row">
                <div class="am-content ap-left col-md-12 col-lg-7 am-scroll am-mbile-menu-tab">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><strong><i class="fa ft-edit" aria-hidden="true"></i> </strong><?=lang("Create new")?></h2>
                        </div>
                        <div class="body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="tab-type schedule-<?=$module_name?>-type file-manager-change-type">
                                        <a href="#media" class="col-xs-4 col-sm-4 col-md-4 item active"
                                            data-toggle="tab" data-type="media" data-type-image="multi">
                                            <i class="ft-camera"></i> <?=lang('media')?>
                                            <input type="radio" name="type" class="hide" value="media" checked="">
                                        </a>
                                        <a href="#link" class="col-xs-4 col-sm-4 col-md-4 item" data-toggle="tab"
                                            data-type="link">
                                            <i class="ft-link"></i> <?=lang('link')?>
                                            <input type="radio" name="type" class="hide" value="link">
                                        </a>
                                        <a href="#text" class="col-xs-4 col-sm-4 col-md-4 item" data-toggle="tab"
                                            data-type="text">
                                ...
                                <div class="schedule-option" id="schedule-option">
                                    <div class="row">
                                        ...
                                        <div class="col-12 box-repeat <?=$ids == ""?"hide":""?>">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">

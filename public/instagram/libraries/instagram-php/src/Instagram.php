...
class Instagram implements ExperimentsInterface
{
        ...
        array $storageConfig = [])
    {
        ...
        $this->checkpoint = Checkpoint\Checkpoint::createHandler($this);
     ...
     * @throws \InstagramAPI\Exception\InstagramException
     */
    public function _setUserWithoutPassword(
        $username)
    {
     ...
     * @throws \InstagramAPI\Exception\InstagramException
     */
    public function _sendPreLoginFlow()
    {
     ...
     */
    public function _registerPushChannels()
    {

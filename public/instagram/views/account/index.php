<div class="col-md-6 col-lg-4 account-manager">
    <div class="card">
        <div class="header">
            <h2 class="card-title">
                <strong><i class="fa fa-instagram" aria-hidden="true"></i> </strong><?=$module_name?>
                    ...
                    <div class="am-option">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li style="display: none;"><a href="<?=cn($module."/clear_cookies/$row->ids")?>" class="actionItem" data-id="<?=$row->ids?>"><?=lang("Clear cookies")?></a></li>
